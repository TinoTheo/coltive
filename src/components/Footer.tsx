...
const Footer = () => {
  return (
    <footer className="w-full bg-accent-3 py-12 md:py-16 border-t border-accent-2">
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className="flex justify-center space-x-6 md:space-x-8">
          ...
          <SocialIcon 
            href="#"
            iconPath="M512 256C512 114.6 397.4 0 256 0S0 114.6 0 256C0 376 82.7 476.8 194.2 504.5V334.2H141.4V256h52.8V222.3c0-87.1 39.4-127.5 125-127.5c16.2 0 44.2 3.2 55.7 6.4V172c-6-.6-16.5-1-29.6-1c-42 0-58.2 15.9-58.2 57.2V256h83.6l-14.4 78.2H287V510.1C413.8 494.8 512 386.9 512 256h0z"
            label="Facebook"
          />
          ...
          <SocialIcon 
            href="#"
            iconPath="M256 48C141.1 48 48 141.1 48 256s93.1 208 208 208 208-93.1 208-208S370.9 48 256 48zm-6.4 299.5c-2.5 3.1-5.3 4.2-8.5 4.2-3.7 0-6.5-1.6-8.8-4.2-2.2-2.6-2.3-5.6-.3-9.1l19.8-31c1.9-3 4.5-4.5 7.8-4.5s5.9 1.5 7.8 4.5l19.8 31c2 3.5 1.9 6.5-.3 9.1zm-8.5-161.5c-13.9 0-25.1 11.2-25.1 25.1 0 13.9 11.2 25.1 25.1 25.1 13.9 0 25.1-11.2 25.1-25.1 0-13.9-11.2-25.1-25.1-25.1zm100.5 121.5c0 4.4-3.6 8-8 8H166.4c-4.4 0-8-3.6-8-8v-16c0-4.4 3.6-8 8-8h175.2c4.4 0 8 3.6 8 8v16z"
            label="Threads"
          />
        </div>
      </div>
...
const SocialIcon = ({ href, iconPath, label }: { 
  ...
  >
    <svg 
      className="w-6 h-6 md:w-8 md:h-8 fill-primary group-hover:fill-secondary transition-colors"
      viewBox="0 0 512 512"
    >
      <path d={iconPath} />
    </svg>
